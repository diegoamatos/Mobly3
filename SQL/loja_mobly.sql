...
--
-- Host: localhost:3306
-- Generation Time: 29-Jan-2018 às 02:18
...
--
-- Estrutura da tabela `mb_caracteristicas`
--

CREATE TABLE `mb_caracteristicas` (
  `caract_id` int(11) NOT NULL,
  `caract_nome` varchar(50) CHARACTER SET latin1 DEFAULT NULL,
  `caract_valor` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Extraindo dados da tabela `mb_caracteristicas`
--

INSERT INTO `mb_caracteristicas` (`caract_id`, `caract_nome`, `caract_valor`) VALUES
(1, 'Cor', 'Preto'),
(3, 'Garantia', '3 meses'),
(4, 'Descrição do Tamanho', 'Aberto: Altura 95 cm Largura 212 cm Profundidade 131 cm / Fechado: Altura 95 cm Largura 212 cm Profundidade 92 cm​'),
(5, 'Especificações técnicas', 'Mora em apartamento?\r\n\r\nVerifique o tamanho de elevadores e portas para transporte do produto.\r\n\r\nNossos entregadores sobem somente até o 3º andar pelas escadas.'),
(6, 'Altura', '95 cm'),
(7, 'Largura', '212 cm'),
(8, 'Profundidade', '131 cm'),
(9, 'Peso', '55,000 kg'),
(10, 'Cor', 'Branco'),
(11, 'Altura', '5 cm'),
(12, 'Largura', '200 cm'),
(13, 'Profundidade', '240 cm'),
(14, 'Peso', '5000,000 kg'),
(15, 'Cor', 'Pérola'),
(16, 'Descrição do Tamanho', '5 x 200 x 240'),
(17, 'Altura', '18 cm'),
(18, 'Largura', '45 cm'),
(19, 'Profundidade', '45 cm'),
(20, 'Peso', '1,500 kg'),
(21, 'Cor', 'Amarelo'),
(22, 'Descrição do Tamanho', '03 Almofadas 45 x 45cm');

-- --------------------------------------------------------

--
-- Estrutura da tabela `mb_carrinho`
--

CREATE TABLE `mb_carrinho` (
  `carrinho_id` int(11) NOT NULL,
  `carrinho_cod` int(11) DEFAULT NULL,
  `carrinho_nome` varchar(255) DEFAULT NULL,
  `carrinho_preco` decimal(10,2) DEFAULT NULL,
  `carrinho_quantidade` int(11) DEFAULT NULL,
  `carrinho_sessao` text
) ENGINE=MyISAM DEFAULT CHARSET=latin1;

--
-- Extraindo dados da tabela `mb_carrinho`
--

INSERT INTO `mb_carrinho` (`carrinho_id`, `carrinho_cod`, `carrinho_nome`, `carrinho_preco`, `carrinho_quantidade`, `carrinho_sessao`) VALUES
(108, 266032308, 'Sofá 3 Lugares Retrátil Fluence Suede Capuccino', '974.99', 1, 't2i3je4qq5e8mlbs8di11j6im4'),
(109, 266032308, 'Sofá 3 Lugares Retrátil Fluence Suede Capuccino', '974.99', 1, 'henedgp1fhs856j2r3oucdli27'),
(110, 227014349, 'KIT 3 Almofadas Decorativas Flamingos 45 x 45cm Amarelo', '89.90', 1, 'henedgp1fhs856j2r3oucdli27');

-- --------------------------------------------------------

--
-- Estrutura da tabela `mb_categorias`
--

CREATE TABLE `mb_categorias` (
  `categoria_id` int(11) NOT NULL,
  `categoria_pai` int(11) DEFAULT NULL,
  `categoria_nome` varchar(255) CHARACTER SET latin1 DEFAULT NULL,
  `categoria_titulo` varchar(255) CHARACTER SET latin1 DEFAULT NULL,
  `categoria_conteudo` text CHARACTER SET latin1,
  `categoria_cadastro` timestamp NULL DEFAULT NULL,
  `categoria_visualizacoes` decimal(10,0) DEFAULT NULL,
  `categoria_ultima_visual` timestamp NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Extraindo dados da tabela `mb_categorias`
--

INSERT INTO `mb_categorias` (`categoria_id`, `categoria_pai`, `categoria_nome`, `categoria_titulo`, `categoria_conteudo`, `categoria_cadastro`, `categoria_visualizacoes`, `categoria_ultima_visual`) VALUES
(1, NULL, 'moveis', 'Móveis', 'Na Mobly você encontra o móvel para sua casa em até 10x sem juros, preços imperdíveis, e grande variedade de sofás, guarda-roupas, poltronas e muito mais.', '2018-01-21 01:39:13', '28', '2018-01-29 04:05:56'),
(2, 1, 'sofas', 'Sofás', 'Aproveite os modelos incríveis de sofá. Na Mobly você encontra jogo de sofá, sofá retrátil, sofá com chaise. Conheça nossos produtos e inove!', '2018-01-21 01:39:48', '7', '2018-01-29 04:02:13'),
(3, 1, 'cadeiras', 'Cadeiras', 'São diversos modelos para que você encontre a opção que mais te agrada e que combine com o restante do ambiente.', '2018-01-18 01:41:00', '3', '2018-01-29 04:01:06'),
(4, 1, 'guarda-roupas', 'Guarda-Roupas', 'Encontre o guarda-roupa ideal\r\npara você! São inúmeras opções para deixar o seu quarto do seu jeito.', '2018-01-18 01:41:38', '2', '2018-01-29 04:01:43'),
(5, 1, 'armarios', 'Armários', 'Encontre diversos modelos de armário para sua casa, são as melhores opções para banheiro, cozinha, escritório, multiuso e infantil. Confira nosso catálogo e garanta já o seu!', '2018-01-18 01:42:15', '1', '2018-01-25 00:26:36'),
(6, NULL, 'decoracao', 'Decoração', 'A Mobly tem todos os móveis que você precisa para decorar sua casa, do jeito que você sempre sonhou. Navegue nos banners abaixo e encontre o móvel ideal para cada cantinho da sua casa.', '2018-01-18 03:57:06', '8', '2018-01-29 03:56:06'),
(7, 6, 'tapetes', 'Tapetes', 'Capachos, passadeiras, tapetes de cozinha ou tapetes para sala. Todos trazem sempre a sensação de aconchego e dão estilo ao cômodo.\r\nNão deixe de ter o seu!', '2018-01-18 01:44:44', '1', '2018-01-25 00:26:41'),
(8, 6, 'almofadas-e-mantas', 'Almofadas e Mantas', 'Encontramos diversos modelos de almofadas e mantas para decorar com estilo e criatividade.', '2018-01-18 01:45:04', '5', '2018-01-27 06:22:42'),
(9, 6, 'adesivos-de-parede', 'Adesivos de Parede', 'Para modernizar sua casa ou deixá-la mais a sua cara, que tal escolher alguns adesivos de parede? São diversas opções para você decidir a que combina mais com você. Não perca tempo e confira nossos adesivos.', '2018-01-18 01:46:01', NULL, NULL),
(10, 6, 'cortinas', 'Cortinas', 'Para trazer o estilo que faltava em seu cômodo, nada melhor do que escolher a cortina ideal e que combina com o ambiente. Confira nossos produtos e escolha a cortina que mais se adequa à sua personalidade!', '2018-01-18 01:46:35', '4', '2018-01-27 02:47:03'),
(11, NULL, 'iluminacao', 'Iluminação', 'Utilize luminárias, lustres ou abajures para criar um boa iluminação e deixar a sua casa mais confortável.', '2018-01-21 19:13:13', '5', '2018-01-29 03:44:21'),
(12, 11, 'abajures', 'Abajures', 'O abajur é uma peça fundamental em toda casa. Ele serve para iluminar e decorar, por isso, não deixe de procurar aqui na Mobly o abajur que mais combine com você e harmonize na decoração de sua casa.', '2018-01-21 19:15:01', '1', '2018-01-25 00:48:47');

-- --------------------------------------------------------

--
-- Estrutura da tabela `mb_pedidos`
--

CREATE TABLE `mb_pedidos` (
  ...
  `pedido_pagamento` varchar(100) DEFAULT NULL,
  `pedido_parcelas` int(11) DEFAULT NULL,
  `pedido_data` datetime DEFAULT CURRENT_TIMESTAMP,
  `pedido_status` varchar(150) DEFAULT NULL
) ENGINE=MyISAM DEFAULT CHARSET=latin1;

--
-- Extraindo dados da tabela `mb_pedidos`
--

INSERT INTO `mb_pedidos` (`pedido_id`, `pedido_codigo`, `pedido_usuario`, `pedido_produto`, `pedido_quantidade`, `pedido_pagamento`, `pedido_parcelas`, `pedido_data`, `pedido_status`) VALUES
(6, 105233227, 1, 217014349, 2, 'Boleto', 1, '2018-01-26 23:32:27', 'Em andamento'),
(5, 105233227, 1, 247014349, 1, 'Boleto', 1, '2018-01-26 23:32:27', 'Em andamento'),
(4, 105233227, 1, 266032308, 1, 'Boleto', 1, '2018-01-26 23:32:27', 'Em andamento'),
(7, 105233227, 1, 227014349, 1, 'Boleto', 1, '2018-01-26 23:32:27', 'Em andamento'),
(8, 158004734, 1, 197014349, 1, 'Boleto', 1, '2018-01-27 00:47:34', 'Em andamento'),
(9, 169010429, 3, 266032308, 1, 'Boleto', 1, '2018-01-29 01:04:29', 'Em andamento'),
(10, 169010429, 3, 227014349, 1, 'Boleto', 1, '2018-01-29 01:04:29', 'Em andamento'),
(11, 175011243, 3, 207014349, 1, 'Boleto', 1, '2018-01-29 01:12:43', 'Em andamento'),
(12, 175011243, 3, 227014349, 1, 'Boleto', 1, '2018-01-29 01:12:43', 'Em andamento');

-- --------------------------------------------------------

--
-- Estrutura da tabela `mb_produtos`
--

CREATE TABLE `mb_produtos` (
  `produto_id` int(11) NOT NULL,
  `produto_nome` varchar(255) CHARACTER SET latin1 DEFAULT NULL,
  `produto_titulo` varchar(255) CHARACTER SET latin1 DEFAULT NULL,
  `produto_conteudo` longtext CHARACTER SET latin1,
  `produto_preco` decimal(10,2) DEFAULT NULL,
  `produto_capa` varchar(255) CHARACTER SET latin1 DEFAULT NULL,
  `produto_data` timestamp NULL DEFAULT NULL,
  `produto_usuario` int(11) DEFAULT NULL,
  `produto_categoria` int(11) DEFAULT NULL,
  `produto_cat_pai` int(11) DEFAULT NULL,
  `produto_caract` text,
  `produto_codigo` int(11) DEFAULT NULL,
  `produto_visualizacoes` decimal(10,0) DEFAULT '0',
  `produto_ultima_visual` timestamp NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
  `produto_status` int(11) DEFAULT NULL,
  `produto_tipo` varchar(255) CHARACTER SET latin1 DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Extraindo dados da tabela `mb_produtos`
--

INSERT INTO `mb_produtos` (`produto_id`, `produto_nome`, `produto_titulo`, `produto_conteudo`, `produto_preco`, `produto_capa`, `produto_data`, `produto_usuario`, `produto_categoria`, `produto_cat_pai`, `produto_caract`, `produto_codigo`, `produto_visualizacoes`, `produto_ultima_visual`, `produto_status`, `produto_tipo`) VALUES
(1, 'cortina-arezzo-400x270-cm-marfim-e-fendi', 'Cortina Arezzo 400x270 Cm Marfim e fendi', '<p><span>O ambiente fica muito mais bonito e agrad&aacute;vel quando est&aacute; acompanhado de acess&oacute;rios que agregam valor em sua decora&ccedil;&atilde;o, n&atilde;o &eacute; verdade? &Eacute; exatamente isso que a&nbsp;</span><strong>Cortina Arezzo</strong><span>&nbsp;ir&aacute; proporcionar em sua casa! Charmosa e absolutamente&nbsp;</span><strong>elegante</strong><span>, ela dar&aacute; uma renovada na sua sala, fazendo com que voc&ecirc; receba muitos elogios de suas visitas pelo&nbsp;</span><strong>bom gosto</strong><span>&nbsp;na decora&ccedil;&atilde;o. Fabricada nas cores marfim e fendi, ela d&aacute; um toque mais clean e sofisticado ao c&ocirc;modo. Uma gra&ccedil;a, n&eacute;? : )</span></p>', '214.00', 'images/2018/01/cortina-arezzo-400x270-cm-marfim-e-fendi.jpg', '2018-01-18 04:01:36', 1, 10, 6, '{\"garantia\":3,\"especificacoes-tecnicas\":5,\"largura\":12,\"descricao-do-tamanho\":16,\"profundidade\":13,\"peso\":20,\"altura\":6,\"cor\":10}', 197014349, '6', '2018-01-27 02:47:07', 1, 'produto'),
(3, 'sofa-3-lugares-retratil-fluence-suede-preto', 'Sofá 3 Lugares Retrátil Fluence Suede Preto', '<p><span>A sala de estar &eacute; um dos principais c&ocirc;modos da casa, pois &eacute; nela que recebemos nossas visitas e passamos longos momentos de lazer ao lado de amigos e familiares. Para melhor recepcion&aacute;-los, o&nbsp;</span><strong>Sof&aacute; Fluence</strong><span>&nbsp;&eacute; uma excelente op&ccedil;&atilde;o, aliando conforto e eleg&acirc;ncia de maneira espl&ecirc;ndida. Al&eacute;m de um visual absolutamente distinto e muito sofisticado, o modelo conta com&nbsp;</span><strong>assentos retr&aacute;teis</strong><span>, permitindo que voc&ecirc; estique as pernas para poder relaxar e descansar plenamente.</span></p>', '975.00', 'images/2018/01/sofa-3-lugares-retratil-fluence-suede-preto.jpg', '2018-01-18 04:11:12', 1, 2, 1, '{\"cor\":1,\"garantia\":3,\"altura\":6,\"largura\":7,\"profundidade\":8,\"peso\":9,\"descricao-do-tamanho\":4,\"especificacoes-tecnicas\":5}', 207014349, '29', '2018-01-29 03:56:48', 1, 'produto'),
(4, 'tapete-shaggy-pelo-alto-200-x-240-cm-perola-tapetes-saturs', 'Tapete Shaggy Pelo Alto 200 x 240 cm - Pérola Tapetes Saturs', '<p>Composi&ccedil;&atilde;o Alto Padr&atilde;o 100% Seda e Poli&eacute;ster.</p>\r\n<p><span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></p>\r\n<p>- Diversas Cores e Tons, Com Brilho Natural.</p>\r\n<p>-&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>\r\n<p><span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></p>\r\n<p>- Fabrica&ccedil;&atilde;o Pr&oacute;pria Saturs Tapetes e Decora&ccedil;&otilde;es &ndash; Distribuidora e Industria Textil.&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>\r\n<p><span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></p>\r\n<p>- Distribui&ccedil;&atilde;o Exclusiva Saturs</p>\r\n<p><span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></p>\r\n<p>- Comprimento do Fio 45mm aproximadamente.&nbsp;&nbsp;&nbsp;&nbsp;</p>\r\n<p><span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></p>\r\n<p>- Medidas 200 x 240 cm&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>\r\n<p><span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></p>\r\n<p>-&nbsp;&nbsp;&nbsp;&nbsp;</p>\r\n<p><span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></p>\r\n<p>- Prote&ccedil;ao Anti&aacute;caro&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>\r\n<p><span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></p>\r\n<p>- Prote&ccedil;ao Anti-Mofo&nbsp;</p>\r\n<p><span>&nbsp;&nbsp;&nbsp;&nbsp;</span></p>\r\n<p>- Prote&ccedil;ao Anti-al&eacute;rgico&nbsp;</p>\r\n<p><span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></p>\r\n<p>- Prote&ccedil;ao Anti-derrapante&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>\r\n<p><span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></p>\r\n<p>Preocupa&ccedil;ao com a sa&uacute;de e bem estar da sua familia&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>\r\n<p><span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></p>\r\n<p>- F&aacute;cil Manuten&ccedil;&atilde;o e Limpeza fios sedosos facilitam a retirada de impurezas&nbsp;</p>\r\n<p><span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></p>\r\n<p>Cores est&aacute;veis que n&atilde;o desbotam nas lavagens e nem com a exposi&ccedil;&atilde;o solar</p>\r\n<p><span>&nbsp;</span></p>\r\n<p>- Ortopedicamente correto&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>\r\n<p><span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></p>\r\n<p>Transmitem menor impacto as articula&ccedil;&otilde;es&nbsp;&nbsp;&nbsp;&nbsp;</p>\r\n<p><span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></p>\r\n<p><strong>ISO&nbsp; 9001</strong></p>\r\n<p>Empresa certificada Iso 9001 sistema de gestao de qualidade.</p>\r\n<p><span>&nbsp;</span></p>\r\n<p><strong>ISO 14001</strong></p>\r\n<p><span>&nbsp;</span></p>\r\n<p>Empresa certificada Iso 14001 sistema de gestao ambiental.</p>\r\n<p><span>&nbsp;</span></p>\r\n<p><strong>Certifica&ccedil;ao Green Label Plus</strong></p>\r\n<p><span>&nbsp;</span></p>\r\n<p>Produtos ecoligicamente ideais para serem utilizados em diversos tipos de ambientes.</p>\r\n<p><span>&nbsp;</span></p>\r\n<p>Certifique-se de que o tapete esteja bem seco antes de reutiliza-lo&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>\r\n<p><span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></p>\r\n<p>Este produto textil, podera ter uma tolerancia maxima de 2% sob a area total&nbsp; (comp x larg)</p>\r\n<p><span>&nbsp;</span></p>\r\n<p><strong>Conforme portaria 166/2003 do INMETRO /fabricado no Brasil&nbsp;&nbsp;</strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>\r\n<p><span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></p>\r\n<p>Diferentes lotes de produ&ccedil;ao podem apresentar m&iacute;nimas varia&ccedil;oes de tonalidades</p>', '259.90', 'images/2018/01/tapete-shaggy-pelo-alto-200-x-240-cm-perola-tapetes-saturs.jpg', '2018-01-21 13:56:41', 1, 7, 6, '{\"garantia\":3,\"especificacoes-tecnicas\":5,\"largura\":12,\"descricao-do-tamanho\":16,\"profundidade\":13,\"peso\":20,\"altura\":6,\"cor\":10}', 217014349, '18', '2018-01-29 03:55:13', 1, 'produto'),
(5, 'kit-3-almofadas-decorativas-flamingos-45-x-45cm-amarelo', 'KIT 3 Almofadas Decorativas Flamingos 45 x 45cm Amarelo', '<p><span>As almofadas Pump UP s&atilde;o tudo de bom, n&atilde;o &eacute; mesmo? Elas deixam o ambiente mais aconchegante e ainda s&atilde;o &oacute;timas para implementar a decora&ccedil;&atilde;o. Este maravilhoso kit de almofadas estampadas e lisas foram desenvolvidas pensando em voc&ecirc; que gosta de ambientes com um toque moderno e criativo! Com ela voc&ecirc; transformar&aacute; sua casa ou escrit&oacute;rio. Nossas almofadas vem com a frente estampada, a cor das costas sempre ser&aacute; em uma cor lisa num sobretom, mantendo ela linda e exuberante. Voc&ecirc; vai amar nossas almofadas, pode confiar!</span></p>', '89.90', 'images/2018/01/kit-3-almofadas-decorativas-flamingos-45-x-45cm-amarelo.jpg', '2018-01-21 14:07:25', 1, 8, 6, '{\"garantia\":3,\"especificacoes-tecnicas\":5,\"largura\":12,\"descricao-do-tamanho\":16,\"profundidade\":13,\"peso\":20,\"altura\":6,\"cor\":10}', 227014349, '18', '2018-01-29 03:56:22', 1, 'produto'),
(6, 'sofa-3-lugares-retratil-fluence-suede-capuccino', 'Sofá 3 Lugares Retrátil Fluence Suede Capuccino', '<p><span>Del&iacute;cia &eacute; poder chegar em&nbsp;</span><strong>casa</strong><span>&nbsp;e relaxar assistindo aos seus programas de&nbsp;</span><strong>TV</strong><span>&nbsp;preferidos, n&atilde;o &eacute;? Com o&nbsp;</span><strong>Sof&aacute; Retr&aacute;til Clipper</strong><span>&nbsp;essa tarefa ficar&aacute; ainda mais f&aacute;cil. Feito com&nbsp;</span><strong>materiais resistentes</strong><span>, mas sem deixar o conforto de lado, ele &eacute; o&nbsp;</span><strong>m&oacute;vel</strong><span>&nbsp;que faltava pra deixar seu lar mais completo.</span></p>', '974.99', 'images/2018/01/sofa-3-lugares-retratil-fluence-suede-capuccino.jpg', '2018-01-21 14:40:10', 1, 2, 1, '{\"especificacoes-tecnicas\":5,\"garantia\":3,\"descricao-do-tamanho\":4,\"profundidade\":13,\"peso\":14,\"altura\":6,\"largura\":7,\"cor\":10}', 266032308, '59', '2018-01-29 04:13:12', 1, 'produto'),
(7, 'abajur-bola-com-aluminio-terra-a', 'Abajur Bola com Alumínio Terra A', '<p><span>Procurando por uma pe&ccedil;a diferenciada para deixar seu lar mais aconchegante e agrad&aacute;vel? Pois este&nbsp;</span><strong>Abajur Bola Terra</strong><span>&nbsp;&eacute; a op&ccedil;&atilde;o perfeita! N&atilde;o h&aacute; nada como poder relaxar em um ambiente &agrave; meia-luz, seja lendo um livro, vendo um filme ou conversando com algu&eacute;m querido. E que tal uma ilumina&ccedil;&atilde;o mais fraca para momentos mais rom&acirc;nticos? Seja ao lado do sof&aacute;, da poltrona ou da cama, esta pe&ccedil;a transformar&aacute; seus dias. Se em sua casa n&atilde;o pode faltar eleg&acirc;ncia, ent&atilde;o esta base n&atilde;o pode faltar em sua casa!</span></p>', '199.90', 'images/2018/01/abajur-bola-com-aluminio-terra-a.jpg', '2018-01-21 19:16:10', 1, 12, 11, '{\"garantia\":3,\"especificacoes-tecnicas\":5,\"largura\":18,\"descricao-do-tamanho\":16,\"profundidade\":19,\"peso\":20,\"altura\":11,\"cor\":15}', 247014349, '12', '2018-01-27 01:29:56', 1, 'produto'),
(8, 'abajur-princi-grande-luna-branco', 'Abajur Princi Grande Luna Branco', '<h2>Por que o Abajur Princi Luna?</h2>\r\n<p>Procurando por uma pe&ccedil;a diferenciada para deixar seu lar mais aconchegante e agrad&aacute;vel? Pois este&nbsp;<strong>Abajur Princi Luna</strong>&nbsp;&eacute; a op&ccedil;&atilde;o perfeita! N&atilde;o h&aacute; nada como poder relaxar em um ambiente &agrave; meia-luz, seja lendo um livro, vendo um filme ou conversando com algu&eacute;m querido. E que tal uma ilumina&ccedil;&atilde;o mais fraca para momentos mais rom&acirc;nticos? Seja ao lado do sof&aacute;, da poltrona ou da cama, esta pe&ccedil;a transformar&aacute; seus dias. Se em sua casa n&atilde;o pode faltar eleg&acirc;ncia, ent&atilde;o esta base n&atilde;o pode faltar em sua casa!</p>', '194.99', 'images/2018/01/abajur-princi-grande-luna-branco.jpg', '2018-01-29 03:41:23', 1, 12, 11, '{\"especificacoes-tecnicas\":5,\"garantia\":3,\"largura\":18,\"descricao-do-tamanho\":22,\"profundidade\":19,\"peso\":20,\"altura\":11,\"cor\":10}', 197014413, '3', '2018-01-29 03:49:02', 1, 'produto'),
(9, 'abajur-polaris-transparente-pequeno', 'Abajur Poláris Transparente - Pequeno', '<p><span>Uma reminisc&ecirc;ncia dos&nbsp;</span><em>Anos 70.</em><span>O&nbsp;</span><strong>Abajur Pol&aacute;ris</strong><span>&nbsp;&eacute; um &iacute;cone que contou com jovialidade, alegria e inspira&ccedil;&atilde;o cl&aacute;ssica, revisitando o estilo barroco. A inven&ccedil;&atilde;o revolucion&aacute;ria deste abajur &eacute; que &eacute; feito inteiramente em policarbonato transparente. Por um lado, cl&aacute;ssico, rico e tradicional e, por outro, inovadora transpar&ecirc;ncia e ironia.&nbsp;O Material e processamento s&atilde;o de alt&iacute;ssima qualidade fazendo com que pare&ccedil;a um precioso cristal. A base de estilo barroco &eacute; constitu&iacute;da por tr&ecirc;s camadas decoradas que se cruzam entre si, e a grande capa &eacute; feita com um efeito plisse, para criar um jogo de reflexos quando aceso.&nbsp;&nbsp;Pode us&aacute;-lo na sala de estar, ou coloc&aacute;-la na mesa de cabeceira para uma ilumina&ccedil;&atilde;o evocativa de seu quarto. Como um objeto escult&oacute;rico, pode ser colocado diretamente no ch&atilde;o, ou usado como uma para leitura em uma mesa.&nbsp;</span></p>', '479.00', 'images/2018/01/abajur-polaris-transparente-pequeno.jpg', '2018-01-29 03:45:10', 1, 12, 11, '{\"especificacoes-tecnicas\":5,\"garantia\":3,\"profundidade\":19,\"peso\":20,\"altura\":11,\"largura\":18,\"descricao-do-tamanho\":22,\"cor\":15}', 200014813, '1', '2018-01-29 03:56:32', 1, 'produto'),
(10, 'tapete-essential-200x300-cm-cinza-piano-apaeb', 'Tapete Essential 200x300 cm Cinza Piano Apaeb', '<h2>Sobre o Tapete Essential</h2>\r\n<p>Com trama diferenciada e cores modernas, esse tapete se encaixa perfeitamente em qualquer estilo de decora&ccedil;&atilde;o.&nbsp;<strong>Ele &eacute; ideal para dar um aspecto diferenciado ao visual da casa</strong>&nbsp;e transformar a sala de jantar e sala de estar em um espa&ccedil;o extremamente aconchegante e agrad&aacute;vel.</p>\r\n<p>&nbsp;</p>\r\n<p>Fabricado em fibra de sisal,&nbsp;<strong>material biodegrad&aacute;vel e ecologicamente correto</strong>&nbsp;que agrega modernidade e beleza &agrave; composi&ccedil;&atilde;o do ambiente. Com dimens&atilde;o de 180x200cm, ele foi pensado para oferecer praticidade ao dia a dia, pois pode ser limpo facilmente com &aacute;gua e sab&atilde;o ou com o uso do aspirador de p&oacute;.</p>\r\n<p>&nbsp;</p>\r\n<p>O tapete Essential cinza piano &eacute; produzido pela Apaeb, empresa que se preocupa em oferecer produtos de qualidade e com a preserva&ccedil;&atilde;o do meio ambiente. Ela tem como uma das principais mat&eacute;rias-primas a fibra de sisal, produto natural que se decomp&otilde;e sem poluir a natureza.</p>', '759.99', 'images/2018/01/tapete-essential-200x300-cm-cinza-piano-apaeb.jpg', '2018-01-29 03:50:32', 1, 7, 6, '{\"garantia\":3,\"especificacoes-tecnicas\":5,\"largura\":7,\"descricao-do-tamanho\":16,\"profundidade\":13,\"peso\":20,\"altura\":6,\"cor\":15}', 203015332, '0', NULL, 1, 'produto'),
(11, 'apete-herat-export-retangular-polipropileno-200x250-classico', 'apete Herat Export Retangular Polipropileno 200x250 Classico', '<h2>Por que o Tapete Herat Export?</h2>\r\n<p>Lindo, n&atilde;o &eacute;? O&nbsp;<strong>Tapete Herat Export</strong>&nbsp;vai completar a decora&ccedil;&atilde;o da sua&nbsp;<strong>sala de estar</strong>, quarto ou outro c&ocirc;modo. Confeccionado com materiais de qualidade, ele conta com desenho&nbsp;<strong>moderno</strong>, perfeito para deixar o espa&ccedil;o ainda mais sofisticado e confort&aacute;vel. Aproveite!</p>', '399.99', 'images/2018/01/apete-herat-export-retangular-polipropileno-200x250-classico.jpg', '2018-01-29 03:53:26', 1, 7, 6, '{\"especificacoes-tecnicas\":5,\"garantia\":3,\"profundidade\":8,\"peso\":20,\"altura\":6,\"largura\":7,\"descricao-do-tamanho\":16,\"cor\":10}', 204015505, '0', NULL, 1, 'produto'),
(12, 'cadeira-de-escritorio-secretaria-java-preta-e-cinza', 'Cadeira de Escritório Secretária Java Preta e Cinza', '<h2>Por que a Cadeira de Escrit&oacute;rio Secret&aacute;ria Java?</h2>\r\n<p>A&nbsp;<strong>Cadeira de Escrit&oacute;rio Secret&aacute;ria Java</strong>&nbsp;&eacute; uma pe&ccedil;a b&aacute;sica e essencial para qualquer&nbsp;<strong>ambiente coorporativo</strong>. Produzida nas cores preto e cinza, proporciona um visual arrojado e elegante ao espa&ccedil;o. Fabricada com materiais seguros e resistentes, ela &eacute; ideal para deixar o seu dia mais agrad&aacute;vel e confort&aacute;vel. Os&nbsp;<strong>rod&iacute;zios</strong>&nbsp;s&atilde;o &oacute;timos para voc&ecirc; se deslocar com mais facilidade! Gostou? : )</p>', '239.99', 'images/2018/01/cadeira-de-escritorio-secretaria-java-preta-e-cinza.jpg', '2018-01-29 03:57:22', 1, 3, 1, '{\"especificacoes-tecnicas\":5,\"garantia\":3,\"descricao-do-tamanho\":16,\"profundidade\":19,\"peso\":20,\"altura\":11,\"largura\":18,\"cor\":1}', 208015940, '2', '2018-01-29 04:09:00', 1, 'produto'),
(13, 'conjunto-com-2-cadeiras-eames-premium-botone-branca', 'Conjunto com 2 Cadeiras Eames Premium Botonê Branca', '<h2>Por que o Conjunto com 2 Cadeiras Eames?</h2>\r\n<p>Complete e transforme a&nbsp;<strong>decora&ccedil;&atilde;o</strong>&nbsp;da sua&nbsp;<strong>sala de jantar</strong>&nbsp;com o aux&iacute;lio deste lindo&nbsp;<strong>Conjunto com 2 Cadeiras Eames</strong>. As&nbsp;<strong>cadeiras</strong>&nbsp;s&atilde;o confeccionadas com assento, encosto e p&eacute;s de&nbsp;<strong>madeira</strong>, s&atilde;o revestidas com&nbsp;<strong>couro sint&eacute;tico</strong>. Charmosas, n&eacute;? Aproveite!</p>', '409.99', 'images/2018/01/conjunto-com-2-cadeiras-eames-premium-botone-branca.jpg', '2018-01-29 03:57:20', 1, 3, 1, '{\"garantia\":3,\"especificacoes-tecnicas\":5,\"peso\":20,\"altura\":11,\"largura\":18,\"descricao-do-tamanho\":16,\"profundidade\":13,\"cor\":10}', 209020108, '0', NULL, 1, 'produto');

-- --------------------------------------------------------

--
-- Estrutura da tabela `mb_produtos_galerias`
--

CREATE TABLE `mb_produtos_galerias` (
  `produto_id` int(11) DEFAULT NULL,
  `galeria_id` int(11) NOT NULL,
  `galeria_imagem` varchar(255) CHARACTER SET latin1 DEFAULT NULL,
  `galeria_data` timestamp NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Extraindo dados da tabela `mb_produtos_galerias`
--

INSERT INTO `mb_produtos_galerias` (`produto_id`, `galeria_id`, `galeria_imagem`, `galeria_data`) VALUES
(4, 1, 'images/2018/01/tapete-shaggy-pelo-alto-200-x-240-cm-perola-tapetes-saturs-gb-4-c25c8.jpg', '2018-01-21 15:35:32'),
(4, 2, 'images/2018/01/tapete-shaggy-pelo-alto-200-x-240-cm-perola-tapetes-saturs-gb-4-12124.jpg', '2018-01-21 15:35:32'),
(7, 3, 'images/2018/01/abajur-bola-com-aluminio-terra-a-gb-7-315c4.jpg', '2018-01-21 19:18:24'),
(7, 4, 'images/2018/01/abajur-bola-com-aluminio-terra-a-gb-7-b81c5.jpg', '2018-01-21 19:18:24'),
(7, 5, 'images/2018/01/abajur-bola-com-aluminio-terra-a-gb-7-f8b0c.jpg', '2018-01-21 19:18:24'),
(8, 6, 'images/2018/01/abajur-princi-grande-luna-branco-gb-8-87536.jpg', '2018-01-29 03:44:14'),
(8, 7, 'images/2018/01/abajur-princi-grande-luna-branco-gb-8-4352b.jpg', '2018-01-29 03:44:14'),
(8, 8, 'images/2018/01/abajur-princi-grande-luna-branco-gb-8-632b2.jpg', '2018-01-29 03:44:14'),
(9, 9, 'images/2018/01/abajur-polaris-transparente-pequeno-gb-9-7625e.jpg', '2018-01-29 03:48:13'),
(9, 10, 'images/2018/01/abajur-polaris-transparente-pequeno-gb-9-10e97.jpg', '2018-01-29 03:48:14'),
(9, 11, 'images/2018/01/abajur-polaris-transparente-pequeno-gb-9-79901.jpg', '2018-01-29 03:48:14'),
(10, 12, 'images/2018/01/tapete-essential-200x300-cm-cinza-piano-apaeb-gb-10-2dc10.jpg', '2018-01-29 03:53:32'),
(10, 13, 'images/2018/01/tapete-essential-200x300-cm-cinza-piano-apaeb-gb-10-c52fe.jpg', '2018-01-29 03:53:32'),
(10, 14, 'images/2018/01/tapete-essential-200x300-cm-cinza-piano-apaeb-gb-10-7909e.jpg', '2018-01-29 03:53:32'),
(11, 15, 'images/2018/01/apete-herat-export-retangular-polipropileno-200x250-classico-gb-11-3f94b.jpg', '2018-01-29 03:55:05'),
(11, 16, 'images/2018/01/apete-herat-export-retangular-polipropileno-200x250-classico-gb-11-318d5.jpg', '2018-01-29 03:55:05'),
(12, 17, 'images/2018/01/cadeira-de-escritorio-secretaria-java-preta-e-cinza-gb-12-06bbf.jpg', '2018-01-29 03:59:40'),
(12, 18, 'images/2018/01/cadeira-de-escritorio-secretaria-java-preta-e-cinza-gb-12-06e5a.jpg', '2018-01-29 03:59:40'),
(12, 19, 'images/2018/01/cadeira-de-escritorio-secretaria-java-preta-e-cinza-gb-12-e4d72.jpg', '2018-01-29 03:59:40'),
(13, 20, 'images/2018/01/conjunto-com-2-cadeiras-eames-premium-botone-branca-gb-13-854d9.jpg', '2018-01-29 04:01:08'),
(13, 21, 'images/2018/01/conjunto-com-2-cadeiras-eames-premium-botone-branca-gb-13-e02af.jpg', '2018-01-29 04:01:08'),
(13, 22, 'images/2018/01/conjunto-com-2-cadeiras-eames-premium-botone-branca-gb-13-10a67.jpg', '2018-01-29 04:01:09');

-- --------------------------------------------------------

--
-- Estrutura da tabela `mb_siteviews`
--

CREATE TABLE `mb_siteviews` (
...
--
-- Extraindo dados da tabela `mb_siteviews`
--

INSERT INTO `mb_siteviews` (`siteviews_id`, `siteviews_date`, `siteviews_users`, `siteviews_views`, `siteviews_pages`) VALUES
(1, '2018-01-20', '9', '27', '371'),
(2, '2018-01-21', '1', '4', '577'),
(3, '2018-01-22', '2', '6', '510'),
(4, '2018-01-23', '2', '2', '48'),
(5, '2018-01-24', '2', '3', '103'),
(6, '2018-01-25', '1', '1', '14'),
(7, '2018-01-26', '3', '6', '361'),
(8, '2018-01-27', '2', '3', '56'),
(9, '2018-01-29', '2', '2', '325');

-- --------------------------------------------------------

--
-- Estrutura da tabela `mb_siteviews_agent`
--

CREATE TABLE `mb_siteviews_agent` (
...
--
-- Extraindo dados da tabela `mb_siteviews_agent`
--

INSERT INTO `mb_siteviews_agent` (`agent_id`, `agent_name`, `agent_views`, `agent_lastview`) VALUES
(1, 'Chrome', '170', '2018-01-29 02:29:16'),
(2, 'Firefox', '68', '2014-02-12 18:13:06'),
(3, 'IE', '57', '2018-01-26 21:47:44'),
(4, 'Outros', '1', '0000-00-00 00:00:00');

-- --------------------------------------------------------

--
-- Estrutura da tabela `mb_siteviews_online`
--

CREATE TABLE `mb_siteviews_online` (
...
--
-- Extraindo dados da tabela `mb_siteviews_online`
--

INSERT INTO `mb_siteviews_online` (`online_id`, `online_session`, `online_startview`, `online_endview`, `online_ip`, `online_url`, `online_agent`, `agent_name`) VALUES
(31, 'mu1ad5jk3dsr7hgjf7b50gisb4', '2018-01-21 13:49:17', '2018-01-22 07:35:37', '200.155.124.191', '/themes/mobly/images/favicon.ico', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/63.0.3239.132 Safari/537.36', 'Chrome'),
(32, 'mu1ad5jk3dsr7hgjf7b50gisb4', '2018-01-21 18:38:23', '2018-01-22 07:35:37', '200.155.124.191', '/themes/mobly/images/favicon.ico', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/63.0.3239.132 Safari/537.36', 'Chrome'),
(33, 'mu1ad5jk3dsr7hgjf7b50gisb4', '2018-01-21 20:45:01', '2018-01-22 07:35:37', '200.155.122.143', '/themes/mobly/images/favicon.ico', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/63.0.3239.132 Safari/537.36', 'Chrome'),
(34, 'mu1ad5jk3dsr7hgjf7b50gisb4', '2018-01-22 00:46:31', '2018-01-22 07:35:37', '200.155.122.143', '/themes/mobly/images/favicon.ico', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/63.0.3239.132 Safari/537.36', 'Chrome'),
(35, 'mu1ad5jk3dsr7hgjf7b50gisb4', '2018-01-22 02:23:22', '2018-01-22 07:35:37', '200.155.122.143', '/themes/mobly/images/favicon.ico', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/63.0.3239.132 Safari/537.36', 'Chrome'),
(36, 'mu1ad5jk3dsr7hgjf7b50gisb4', '2018-01-22 05:23:08', '2018-01-22 07:35:37', '200.155.122.143', '/themes/mobly/images/favicon.ico', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/63.0.3239.132 Safari/537.36', 'Chrome'),
(37, 'jhul7faprj85m57p75qncpic85', '2018-01-22 17:40:07', '2018-01-22 20:09:33', '187.92.211.246', '/themes/mobly/icons/act_delete.png', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/56.0.2924.76 Safari/537.36', 'Chrome'),
(38, 'jhul7faprj85m57p75qncpic85', '2018-01-22 18:57:19', '2018-01-22 20:09:33', '187.92.211.246', '/themes/mobly/icons/act_delete.png', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/56.0.2924.76 Safari/537.36', 'Chrome'),
(39, 'v09plpf95fjj8aira3d55gl727', '2018-01-22 22:00:52', '2018-01-23 06:44:06', '200.155.119.26', '/carrinho/?delete=266032308', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/63.0.3239.132 Safari/537.36', 'Chrome'),
(40, 'v09plpf95fjj8aira3d55gl727', '2018-01-22 23:31:37', '2018-01-23 06:44:06', '186.246.234.164', '/carrinho/?delete=266032308', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/63.0.3239.132 Safari/537.36', 'Chrome'),
(41, 'gpv32oijhg1f24c1o9t966sq17', '2018-01-23 15:11:22', '2018-01-23 15:35:23', '187.92.211.246', '/favicon.ico', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/56.0.2924.76 Safari/537.36', 'Chrome'),
(42, 'bvsh2julch75bpq6qtq02qahr4', '2018-01-24 00:21:26', '2018-01-24 03:06:14', '200.155.122.207', '/favicon.ico', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/63.0.3239.132 Safari/537.36', 'Chrome'),
(43, 'vsmp4d514pgvmdrup8akcadag7', '2018-01-24 15:54:20', '2018-01-25 19:38:33', '187.92.211.246', '/conferir', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/56.0.2924.76 Safari/537.36', 'Chrome'),
(44, 'vsmp4d514pgvmdrup8akcadag7', '2018-01-24 18:52:07', '2018-01-25 19:38:33', '187.92.211.246', '/conferir', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/56.0.2924.76 Safari/537.36', 'Chrome'),
(45, 'i5bp6qhqdpkkncaq0p8n2no793', '2018-01-25 00:13:11', '2018-01-25 01:56:03', '200.155.121.116', '/', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/63.0.3239.132 Safari/537.36', 'Chrome'),
(46, 'vsmp4d514pgvmdrup8akcadag7', '2018-01-25 19:17:35', '2018-01-25 19:38:33', '187.92.211.246', '/conferir', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/56.0.2924.76 Safari/537.36', 'Chrome'),
(47, 't2i3je4qq5e8mlbs8di11j6im4', '2018-01-26 14:56:00', '2018-01-27 06:54:49', '200.155.120.168', '/themes/mobly/jsc/admin.js', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/63.0.3239.132 Safari/537.36', 'Chrome'),
(48, 'tdgdgj3an45p8usg1ghdcgpcl2', '2018-01-26 14:56:33', '2018-01-26 22:07:56', '200.155.120.168', '/carrinho', 'Mozilla/5.0 (Windows NT 10.0; WOW64; Trident/7.0; rv:11.0) like Gecko', 'IE'),
(49, 't2i3je4qq5e8mlbs8di11j6im4', '2018-01-26 16:52:23', '2018-01-27 06:54:49', '200.155.120.168', '/themes/mobly/jsc/admin.js', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/63.0.3239.132 Safari/537.36', 'Chrome'),
(50, 't2i3je4qq5e8mlbs8di11j6im4', '2018-01-26 20:11:46', '2018-01-27 06:54:49', '200.155.122.21', '/themes/mobly/jsc/admin.js', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/63.0.3239.132 Safari/537.36', 'Chrome'),
(51, 't2i3je4qq5e8mlbs8di11j6im4', '2018-01-26 21:40:39', '2018-01-27 06:54:49', '200.155.122.21', '/themes/mobly/jsc/admin.js', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/63.0.3239.132 Safari/537.36', 'Chrome'),
(52, 'tdgdgj3an45p8usg1ghdcgpcl2', '2018-01-26 21:47:44', '2018-01-26 22:07:56', '200.155.122.21', '/carrinho', 'Mozilla/5.0 (Windows NT 10.0; WOW64; Trident/7.0; rv:11.0) like Gecko', 'IE'),
(53, 't2i3je4qq5e8mlbs8di11j6im4', '2018-01-27 04:46:14', '2018-01-27 06:54:49', '200.155.122.21', '/themes/mobly/jsc/admin.js', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/63.0.3239.132 Safari/537.36', 'Chrome'),
(54, 'mn5skqrl3n19qp6c2ko3o75ts2', '2018-01-27 04:46:49', '2018-01-27 05:06:49', '157.55.39.233', '/', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/534+ (KHTML, like Gecko) BingPreview/1.0b', 'Outros'),
(55, 't2i3je4qq5e8mlbs8di11j6im4', '2018-01-27 06:10:07', '2018-01-27 06:54:49', '200.155.122.21', '/themes/mobly/jsc/admin.js', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/63.0.3239.132 Safari/537.36', 'Chrome'),
(56, 'henedgp1fhs856j2r3oucdli27', '2018-01-29 02:17:44', '2018-01-29 02:46:23', '200.155.122.192', '/404', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/63.0.3239.132 Safari/537.36', 'Chrome'),
(57, 'q06osn29b0vpc3gmf1jcn0s326', '2018-01-29 02:29:16', '2018-01-29 04:33:24', '200.155.122.192', '/themes/mobly/jsc/admin.js', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/63.0.3239.132 Safari/537.36', 'Chrome');

-- --------------------------------------------------------

--
-- Estrutura da tabela `mb_usuario`
--

CREATE TABLE `mb_usuario` (
  `id_usuario` int(11) NOT NULL,
  `nome_usuario` varchar(255) CHARACTER SET latin1 NOT NULL,
  `ultimo_usuario` varchar(255) CHARACTER SET latin1 NOT NULL,
  `email_usuario` varchar(255) CHARACTER SET latin1 NOT NULL,
  `senha_usuario` varchar(255) CHARACTER SET latin1 NOT NULL,
  `telefone_usuario` varchar(20) DEFAULT NULL,
  `cpf_usuario` varchar(14) DEFAULT NULL,
  `endereco_usuario` varchar(250) DEFAULT NULL,
  `numero_usuario` varchar(5) DEFAULT NULL,
  `cep_usuario` varchar(10) DEFAULT NULL,
  `bairro_usuario` varchar(200) DEFAULT NULL,
  `cidade_usuario` int(11) NOT NULL DEFAULT '0',
  `estado_usuario` int(11) NOT NULL DEFAULT '0',
  `registrado_usuario` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `atualizacao_usuario` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  `nivel_usuario` int(11) NOT NULL DEFAULT '1'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Extraindo dados da tabela `mb_usuario`
--
...
(1, 'Admin', 'Admin', 'admin@admin.com', 'e10adc3949ba59abbe56e057f20f883e', '900000000', '36565787665', 'Av. Paulista', '16', '1130300', 'Centro', 15, 25, '2018-01-20 13:14:04', '2018-01-21 16:19:40', 3),
(2, 'Cliente', 'Cliente', 'cliente@cliente.com', 'e10adc3949ba59abbe56e057f20f883e', '1100087654', '65432456776', 'Av. Paulista', '160', '11330300', 'Centro', 4850, 25, '2018-01-29 05:24:20', '2018-01-29 09:17:22', 1);
...
--
-- Indexes for table `mb_caracteristicas`
--
ALTER TABLE `mb_caracteristicas`
  ADD PRIMARY KEY (`caract_id`);

--
-- Indexes for table `mb_carrinho`
--
ALTER TABLE `mb_carrinho`
  ADD PRIMARY KEY (`carrinho_id`);

--
-- Indexes for table `mb_categorias`
--
ALTER TABLE `mb_categorias`
  ADD PRIMARY KEY (`categoria_id`);

--
-- Indexes for table `mb_pedidos`
--
ALTER TABLE `mb_pedidos`
  ADD PRIMARY KEY (`pedido_id`);

--
-- Indexes for table `mb_produtos`
--
ALTER TABLE `mb_produtos`
  ADD PRIMARY KEY (`produto_id`);

--
-- Indexes for table `mb_produtos_galerias`
--
ALTER TABLE `mb_produtos_galerias`
  ADD PRIMARY KEY (`galeria_id`);

--
-- Indexes for table `mb_siteviews`
--
ALTER TABLE `mb_siteviews`
  ADD PRIMARY KEY (`siteviews_id`),
  ADD KEY `idx_1` (`siteviews_date`);

--
-- Indexes for table `mb_siteviews_agent`
--
ALTER TABLE `mb_siteviews_agent`
  ADD PRIMARY KEY (`agent_id`),
  ADD KEY `idx_1` (`agent_name`);

--
-- Indexes for table `mb_siteviews_online`
--
ALTER TABLE `mb_siteviews_online`
  ADD PRIMARY KEY (`online_id`);

--
-- Indexes for table `mb_usuario`
--
ALTER TABLE `mb_usuario`
...
--
-- AUTO_INCREMENT for table `mb_caracteristicas`
--
ALTER TABLE `mb_caracteristicas`
  MODIFY `caract_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
--
-- AUTO_INCREMENT for table `mb_carrinho`
--
ALTER TABLE `mb_carrinho`
  MODIFY `carrinho_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=116;
--
-- AUTO_INCREMENT for table `mb_categorias`
--
ALTER TABLE `mb_categorias`
  MODIFY `categoria_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
--
-- AUTO_INCREMENT for table `mb_pedidos`
--
ALTER TABLE `mb_pedidos`
  MODIFY `pedido_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
--
-- AUTO_INCREMENT for table `mb_produtos`
--
ALTER TABLE `mb_produtos`
  MODIFY `produto_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
--
-- AUTO_INCREMENT for table `mb_produtos_galerias`
--
ALTER TABLE `mb_produtos_galerias`
  MODIFY `galeria_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
--
-- AUTO_INCREMENT for table `mb_siteviews`
--
ALTER TABLE `mb_siteviews`
  MODIFY `siteviews_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
--
-- AUTO_INCREMENT for table `mb_siteviews_agent`
--
ALTER TABLE `mb_siteviews_agent`
  MODIFY `agent_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT for table `mb_siteviews_online`
--
ALTER TABLE `mb_siteviews_online`
  MODIFY `online_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=58;
--
-- AUTO_INCREMENT for table `mb_usuario`
--
ALTER TABLE `mb_usuario`
